      ...
      >
        ...
        >
          {allList?.map((item: any, idx: number) => (
            <TableRow key={idx}>
              <TableCell className="text-nowrap">{item?.groupName}</TableCell>
              ...
              <TableCell>
                <div className="flex items-center justify-center gap-x-3">
                  <Tooltip content="View">
                    <Link
                      href={`/admin/kushal-khiladi/master/team-management/view/${item?._id}`}
                    >
                  ...
                  <Tooltip content="Edit">
                    <Link
                      href={`/admin/kushal-khiladi/master/team-management/edit/${item?._id}`}
                    >
