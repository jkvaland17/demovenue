...
import {
  CallGetAdvByCourse,
  CallGetAllCourses,
  CallTypingDownloadCandidateMarks,
  CallGetTypingWorkScopeByVendorId,
...
const DownloadCandidateMarks = (props: Props) => {
  ...
  const getVendorByAdvId = async (advertisementId: string) => {
    ...
    try {
      ...
      const { data, error } = (await CallGetTypingByAdvertisement(
        query,
      )) as any;
  ...
  const getAllWorkScope = async (verdorId: string) => {
    ...
    try {
      ...
      const { data, error } = (await CallGetTypingWorkScopeByVendorId(
        query,
      )) as any;
  ...
  const downloadExamMarks = async () => {
    try {
      ...
      const { data, error } = (await CallTypingDownloadCandidateMarks(
        submitData,
      )) as any;
