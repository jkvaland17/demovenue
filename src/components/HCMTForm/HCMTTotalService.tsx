...
const HCMTTotalService: React.FC<Props> = ({ control, errors }) => {
  return (
    <div className="col-span-2 rounded-md border-1 px-2 pt-3">
      <div className="mb-4 grid grid-cols-3 gap-3">
        <Controller
          name="totalServiceOnDate.years"
          control={control}
        ...
        <Controller
          name="totalServiceOnDate.months"
          control={control}
...
export default HCMTTotalService;
