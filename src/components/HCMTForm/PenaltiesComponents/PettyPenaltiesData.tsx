  ...
  return (
    <>
      <div className="rounded-md border bg-white p-4 shadow-sm">
        <h2 className="mb-5 text-lg font-bold">दीर्घ दण्ड Petty Penalties</h2>
        {pettyPunishmentFields?.map((field: any, index: any) => (
          <div className="mt-6 flex flex-wrap gap-4" key={field.id}>
            <div className="min-w-0 flex-1">
              <Input
                {...register(`pettyPunishment.${index}.countAndYear`, {
            ...
            <div className="min-w-0 flex-1">
              <Input
                {...register(`pettyPunishment.${index}.date`, {
            ...
            <div className="min-w-0 flex-1">
              <Input
                {...register(`pettyPunishment.${index}.incidentDate`, {
            ...
            <div className="col-span-2 flex w-full justify-end gap-3">
              {pettyPunishmentFields?.length > 1 && (
                <Button
                  color="danger"
                  variant="flat"
                  onClick={() => removepettyPunishment(index)}
                >
                  Remove
                </Button>
              )}
