...
const ControlRoom: React.FC<Props> = ({ controlRoomData, centerName }) => {
  const { latitude, longitude, address } = controlRoomData?.location || {};
  const {
    isOpen: isMap,
    onOpen: onMap,
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-700">
              ...
              <span className="font-bold">
                {moment(controlRoomData?.submitDateTime).format(
                  "YYYY-MM-DD HH:mm A",
                )}
              </span>
            </div>
